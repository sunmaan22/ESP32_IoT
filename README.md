...
![대시보드 시연 화면](assets/screenshot.jpg)

</div>

**데모 영상** — [`assets/demo.mp4`](assets/demo.mp4) (아래 플레이어가 보이지 않으면 링크로 재생)

https://github.com/sunmaan22/ESP32_IoT/raw/main/assets/demo.mp4
